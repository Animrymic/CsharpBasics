...
static void PrintCollectionInfo(IEnumerable collection, string name)
{
...
numbers.Add(10);
numbers.Add(123);
numbers.AddRange(11, 22, 33, 43, 54);

numbers.Remove(32);
numbers.Remove(1234); //will not throw exception, but return false if non existing item is tried to be deleted!

PrintCollectionInfo(numbers, "List<int>");


// List of strings
List<string> names = new List<string>() { "Dragan", "Martin", "Mario", "Klementina" };
PrintCollectionInfo(names, "List<string>");
...
PrintCollectionInfo(students, "Dictionary of students");
...
Dictionary<int, User> trainers = new Dictionary<int, User>()
{
    ...
    {2, new User() {Id = 2, FullName = "Greg Smith", Age = 33} },
    {3, new User() {Id = 2, FullName = "John Doe", Age = 33} }
};
...
PrintCollectionInfo(numbersQueue, "Queue");
...
PrintCollectionInfo(namesStack, "Stack");
